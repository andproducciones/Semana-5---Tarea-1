...
-- Schema MVC_3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `MVC_3` DEFAULT CHARACTER SET utf8 ;
USE `MVC_3` ;

-- -----------------------------------------------------
-- Table `MVC_3`.`Proveedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Proveedores` (
...
-- -----------------------------------------------------
-- Table `MVC_3`.`Productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Productos` (
...
-- -----------------------------------------------------
-- Table `MVC_3`.`Unidad_Medida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Unidad_Medida` (
...
-- Table `MVC_3`.`IVA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`IVA` (
...
-- Table `MVC_3`.`Kardex`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Kardex` (
  ...
  CONSTRAINT `fk_Kardex_Unidad_Medida`
    ...
    REFERENCES `MVC_3`.`Unidad_Medida` (`idUnidad_Medida`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Kardex_IVA1`
    ...
    REFERENCES `MVC_3`.`IVA` (`idIVA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Proveedores1`
    FOREIGN KEY (`Proveedores_idProveedores`)
    REFERENCES `MVC_3`.`Proveedores` (`idProveedores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Productos1`
    FOREIGN KEY (`Productos_idProductos`)
    REFERENCES `MVC_3`.`Productos` (`idProductos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MVC_3`.`Clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Clientes` (
...
-- Table `MVC_3`.`Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Factura` (
  ...
  CONSTRAINT `fk_Factura_Clientes1`
    ...
    REFERENCES `MVC_3`.`Clientes` (`idClientes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MVC_3`.`Detalle_Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MVC_3`.`Detalle_Factura` (
  ...
  CONSTRAINT `fk_Detalle_Factura_Factura1`
    ...
    REFERENCES `MVC_3`.`Factura` (`idFactura`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Factura_Kardex1`
    FOREIGN KEY (`Kardex_idKardex`)
    REFERENCES `MVC_3`.`Kardex` (`idKardex`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
